...
| | |
|---|---|
| **Last updated** | 2026-09-21 (session 48) |
...
| **Docs** | Append-only logs sharded (D-023): sessions → `docs/progress/` (`sessions-041-050.md` open at 48), decisions → `docs/decisions/` (shard 2 open — D-041 `--with-doc` semantics), lessons → `docs/lessons/` (`L-076-100.md` open at L-080). Every hard-won lesson goes to `docs/LESSONS.md` (D-024). |
