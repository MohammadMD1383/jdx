...
| **Phase** | Design complete; **M0–M5 DONE**; **M6 in progress** — T-040…T-044 + T-082 DONE, T-045 next (T-046 TODO); M7 TODO |
| **Next task** | **M6 T-045** (`jdx batch` — NDJSON requests on stdin, one envelope per line; HTTP batch already serves the same framing). |
